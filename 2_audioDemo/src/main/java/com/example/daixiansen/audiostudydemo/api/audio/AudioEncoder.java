 ...
 *  @date    2016/04/02
 */
package com.example.daixiansen.audiostudydemo.api.audio;
...
public class AudioEncoder {
    ...
    private static final int DEFAULT_BITRATE = 128 * 1000; //AAC-LC, 64 *1024 for AAC-HE   码率
